...
import { ProxyListSource, ProxyListUpdate, Proxy, ProxyTestRun, ProxyTestType } from 'src/entities';
...
@Module({
  imports: [TypeOrmModule.forFeature([ProxyListSource, ProxyListUpdate, Proxy, ProxyTestRun, ProxyTestType])],
  providers: [ProxyListSourcesService, ProxyListUpdaterService, ProxyTesterService]
})
export class ProxyListModule implements OnModuleInit {
  constructor(private proxyUpdater: ProxyListUpdaterService, 
